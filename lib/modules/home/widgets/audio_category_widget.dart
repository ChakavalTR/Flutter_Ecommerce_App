...
class AudioCategoryWidget extends GetView<HomeController> {
  ...
  SizedBox get _buildCardProduct {
    return SizedBox(
      ...
      child: Obx(() {
        if (controller.isLoading.value) {
        ...
        } else if (controller.audioCategoryProducts.isEmpty) {
          return Center(
            child: Text(
          ...
          return ListView.separated(
            itemCount: controller.audioCategoryProducts.length,
            ...
            itemBuilder: (context, index) {
              final product = controller.audioCategoryProducts[index];
              return Padding(
