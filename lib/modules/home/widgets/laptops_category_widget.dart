...
class LaptopCategoryWidget extends GetView<HomeController> {
  const LaptopCategoryWidget({super.key});
  ...
  SizedBox get _buildCardProduct {
    return SizedBox(
      ...
      child: Obx(() {
        if (controller.isLoading.value) {
        ...
        } else if (controller.laptopCategoryProducts.isEmpty) {
          return Center(
            child: Text(
          ...
          return ListView.separated(
            itemCount: controller.laptopCategoryProducts.length,
            ...
            itemBuilder: (context, index) {
              final product = controller.laptopCategoryProducts[index];
              return Padding(
