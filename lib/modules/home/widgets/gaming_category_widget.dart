...
class GamingCategoryWidget extends GetView<HomeController> {
  const GamingCategoryWidget({super.key});
  ...
  SizedBox get _buildCardProduct {
    return SizedBox(
      ...
      child: Obx(() {
        if (controller.isLoading.value) {
        ...
        } else if (controller.gamingCategoryProducts.isEmpty) {
          return Center(
            child: Text(
          ...
          return ListView.separated(
            itemCount: controller.gamingCategoryProducts.length,
            ...
            itemBuilder: (context, index) {
              final product = controller.gamingCategoryProducts[index];
              return Padding(
