...
class AccessoriesCategoryWidget extends GetView<HomeController> {
  const AccessoriesCategoryWidget({super.key});
  ...
  SizedBox get _buildCardProduct {
    return SizedBox(
      ...
      child: Obx(() {
        if (controller.isLoading.value) {
        ...
        } else if (controller.accessoriesCategoryProducts.isEmpty) {
          return Center(
            child: Text(
          ...
          return ListView.separated(
            itemCount: controller.accessoriesCategoryProducts.length,
            ...
            itemBuilder: (context, index) {
              final product = controller.accessoriesCategoryProducts[index];
              return Padding(
